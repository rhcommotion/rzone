...
?>
  ...
  <p>Select activities by clicking their names.</p>
   <div class="col-sm-12"> <div class="card">
     <div class="card-body">
      ...
      $f = function ($a) {
    	...
    	echo gen_activity_cats_tables('table activity-table', $f);
		?>
	</p>
	<p style="margin-top: 2rem;border-top: 2px dashed silver;">
      ...
      echo gen_activities_table(get_activities(), 'selected-table', $f);
		...
		<p style="position: relative;">
			<button id='appl-all' class="btn btn-primary" onclick='submit();'>Submit</button>
		</p>
    <h4>
      * You can apply for up to
      <?php echo "$max_sel " . ($max_sel === 1 ? 'more activity' : 'more activities'); ?>
      in this round.
